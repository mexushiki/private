...
CONFIG = {
    ...
    "your_name": "Me",              # your name, signs the speech on interface 3
    ...
    "photos": [
        {"src": "photo1.jpg", "caption": "The day it all started"},
        {"src": "photo2.jpg", "caption": "That random Tuesday adventure"},
        {"src": "photo3.jpg", "caption": "You, being you"},
        {"src": "photo4.jpg", "caption": "Best food trip ever"},
        {"src": "photo5.jpg", "caption": "Us, always"},
        {"src": "photo6.jpg", "caption": "One of my favorites"},
    ],
    "speech": (
        "If you're reading this, it means you scrolled all the way here — "
        ...
        "talk to you.\n\n"
        "Thank you for choosing me, for laughing at my bad jokes, for being "
